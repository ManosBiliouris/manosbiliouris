...
const BoxB2 = () => (
  <div className="box-container B2">
    <div className="box sub-box animated-glass-boxB2 center">
      <div className="floating-squaresB2"></div>
      <div className="contentB2">
        <div className="content-innerB2">
    ...
    <div className="box sub-box animated-glass-boxB2 center center1">
      <div className="floating-squaresB2"></div>
      <div className="contentB2">
        <div className="content-innerB2">
