    ...
    <div className="content">
      <div className="content-inner">
        ...
        <div className="content-A1-2">
          <p>
            Yes, I’m part of Gen-Z—meaning I’m fluent in memes, but I can also make
            things for the web that look sharp across any device,
            <span className="italic-text"> transforming pixels into polished, responsive experiences that don’t just work—they
              <span className="highlighted-text"> pop</span>
            </span>.
          </p>
        </div>
